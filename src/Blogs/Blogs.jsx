  ...
  return (
    <>
      ...
      <div className="imageblog1">
        ...
        <Link to='/Multidisciplinary'><div className="imageblog">
          <img src={Multidisciplinary} alt="Cardiac Surgery" /><br /> <br />
          <h2><i style={{ color: 'red', }}>Multidisciplinary Care</i></h2></div>
        </Link>
