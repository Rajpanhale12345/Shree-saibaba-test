 ...
 function Gastroenterology() {
  return (
    ...
    <div>
      ...
      bullet=''
      bullet1='Diagnostic & Therapeutic Endoscopy (Upper GI Endoscopy, Colonoscopy)'
      bullet2='Endoscopic Retrograde Cholangiopancreatography (ERCP) for Bile Duct & Pancreatic Disorders'
      bullet3='Liver Diseases (Hepatitis, Cirrhosis, Fatty Liver, Jaundice Management)'
      bullet4='Pancreatic Disorders & Pancreatitis Care'
      bullet5='Gastrointestinal Bleeding Evaluation & Treatment'
      bullet6='Inflammatory Bowel Disease (IBD) & Irritable Bowel Syndrome (IBS) Management'
      bullet7='Acid Reflux, GERD & Peptic Ulcer Care'
      bullet8='Gastrointestinal Cancer Screening & Management'
