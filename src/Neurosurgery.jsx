 ...
 function Neurosurgery() {
  return (
    ...
    <div>
      ...
      bullet=''
      bullet1='Brain Tumor Surgery (Meningioma, Glioma, Acoustic Neuroma, Pituitary Tumors)'
      bullet2='Aneurysm Clipping and AVM Resection'
      bullet3='Head Injury and Skull Fracture Management'
      bullet4='Hepatobiliary and Gastrointestinal IR'
      bullet5='Minimally Invasive Spine Surgery (MISS)'
      bullet6='Disc Replacement and Discectomy'
