...
function Kidney() {
    ...
    <helmet>
      <title>Kidney | Saibaba Multispeciality Hospital</title>
            ...
            <div className='time1'>
                <Link to='/urology'> <h5 className='time'>🏥Urology</h5></Link>
                <h5 className='time2'> 🕗 11 August 2025</h5>
            </div>

            <br /><br />
            <h4>What is Kidney Stone</h4>
            <span className='down'>⮟</span><br />
            <ul>
               A kidney stone is just a small hard pebble composed of waste that accumulates in your kidneys. These types of stones may pass through your urinary tract and cause significant pain. The majority of kidney stones consist of calcium and oxalate or uric acid.<br /><br />
            </ul>
            <h4>
