...
import img from './Images/urologydep.png'
 ...
 function Urology() {
  return (
    ...
    <div>
      ...
      bullet=''
      bullet1='Laser Kidney Stone Removal (RIRS, PCNL, URS)'
      bullet2='Laparoscopic and Robotic Urological Surgeries'
      bullet3='Prostate Enlargement Treatment (HoLEP, TURP)'
      bullet4='Urologic Cancer Surgery (Kidney, Bladder, Prostate, Testes)'
      bullet5='Reconstructive Urology (Stricture Urethra, Bladder Reconstruction)'
      bullet6='Male Infertility and Erectile Dysfunction Management'
      bullet7='Pediatric Urology (Undescended Testes, Posterior Urethral Valves)'
      bullet8='Treatment for Urinary Incontinence and Neurogenic Bladder'
