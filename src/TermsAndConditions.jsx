        ...
        <>
            ...
            <div style={{ maxWidth: 800, margin: "40px auto", padding: "32px", background: "#fff", borderRadius: 12, boxShadow: "0 2px 16px rgba(0,0,0,0.08)" }}>
                ...
                <ul style={{ marginLeft: 24 }}>
                    ...
                    <li>Diagnostic services (including laboratory tests, imaging, etc.)</li>
                ...
                <section style={{ marginBottom: 24 }}>
                    ...
                    <ul style={{ marginLeft: 24 }}>
                        ...
                        <li>Follow the instructions and recommendations provided by our medical professionals.</li>
                        <li>Inform our staff of any changes in your medical condition or any adverse reactions to treatment.</li>
                        <li>Respect the rights and privacy of other patients and Hospital staff.</li>
                        <li>Adhere to the Hospital's policies and procedures.</li>
                        <li>Be responsible for timely payment of all applicable fees and charges.</li>
                        <li>Keep appointments and notify the Hospital in advance if you need to cancel or reschedule.</li>
                ...
                <section style={{ marginBottom: 24 }}>
                    ...
                    <ul style={{ marginLeft: 24 }}>
                        <li>
                            Appointments can be scheduled through our designated channels (e.g., phone, online portal, in-person). Please contact us at <b>Landline No: 0253 250 7001</b> or <b>Mobile No: 9158887554</b> for appointments.
                        </li>
                        <li>
                            The Hospital reserves the right to reschedule or cancel appointments due to unforeseen circumstances. We will make reasonable efforts to notify you in advance using the contact information provided.
                        </li>
                        <li>
                            Late arrival for appointments may result in rescheduling or a shortened consultation time.
                        </li>
                    </ul>
                </section>
                ...
                <section style={{ marginBottom: 24 }}>
                    ...
                    <ul style={{ marginLeft: 24 }}>
                        <li>
                            The Hospital will maintain your medical records in accordance with applicable laws and regulations.
                        </li>
                        <li>
                            We are committed to protecting the privacy and confidentiality of your personal and medical information. Please refer to our Privacy Policy <span style={{ color: "#2980b9" }}>[Link to Privacy Policy if available on website]</span> for detailed information on how we collect, use, and protect your data.
                        </li>
                    </ul>
                </section>
                ...
                <section style={{ marginBottom: 24 }}>
                    ...
                    <ul style={{ marginLeft: 24 }}>
                        ...
                        <li>Payment terms and accepted modes of payment will be communicated by the Hospital's billing department. For any billing inquiries, please contact us at <b>Landline No: 0253 250 7001</b> or <b>Mobile No: 9158887554</b>.</li>
                        <li>Insurance coverage is subject to the terms and conditions of your insurance policy. It is your responsibility to understand your coverage and obtain any necessary pre-authorizations.</li>
                ...
                <section style={{ marginBottom: 24 }}>
                    ...
                    <ul style={{ marginLeft: 24 }}>
                        ...
                        <li>
                            To the maximum extent permitted by law, Shree Saibaba Heart Institute and Research Centre, its affiliates, officers, employees, and agents shall not be liable for any direct, indirect, incidental, consequential, or special damages arising out of or in any way connected with your use of our services or any delay or inability to use them.
                        </li>
                    </ul>
                </section>
                ...
                <section style={{ marginBottom: 24 }}>
                    ...
                    <address style={{ fontStyle: "normal", marginLeft: 24 }}>
                        ...
                        <div>Opp. Wani House, Mumbai Naka, Mirajkar Nagar, Nashik, Maharashtra 422001</div>
                        <div>Email ID: <a href="mailto:saibabaheartinstitute@yahoo.com" style={{ color: "#2980b9" }}>saibabaheartinstitute@yahoo.com</a></div>
                        <div>Mobile No: <a href="tel:9158887554" style={{ color: "#2980b9" }}>9158887554</a></div>
                        <div>Landline No: <a href="tel:02532507001" style={{ color: "#2980b9" }}>0253 250 7001</a></div>
                        <div>Website: <a href="https://www.shreesaibabaheartinstitute.com/" target="_blank" rel="noopener noreferrer" style={{ color: "#2980b9" }}>www.shreesaibabaheartinstitute.com</a></div>
                    </address>
                </section>
